...
type RegisterType = "usuario" | "tecnico";
...
export default function Cadastro() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // If registering as tecnico, create a technician request
    if (data.user && registerType === "tecnico") {
      await supabase.from("technician_requests").insert({ user_id: data.user.id });
    }
