          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {laboratories.map((lab) => {
              ...
              return (
                <div 
                  key={lab.id} 
                  className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border border-border bg-card shadow-sm hover:shadow-md transition-all cursor-pointer hover:bg-accent/50"
